...
public class Query1_1_day {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env.addSource(consumer)
                ...
                .filter(value -> {
                    ...
                    return vaultId >= 1000 && vaultId <= 1020 && "2023-04-01".equals(date) && s194TemperatureCelsius != 0;
                })
    ...
    public static class CalculateStatistics implements AllWindowFunction<String, String, TimeWindow> {
        ...
        public void apply(TimeWindow window, Iterable<String> values, Collector<String> out) throws Exception {
            ...
            File file = new File("/opt/flink/Results/Query1/Query1_1_day/output_1_day.csv");
